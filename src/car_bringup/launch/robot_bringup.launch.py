...
def generate_launch_description():
    ...
    start_calibrate = LaunchConfiguration("start_calibrate")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("start_calibrate", default_value="true"),
            DeclareLaunchArgument("start_observation", default_value="true"),
            DeclareLaunchArgument(
            ...
            _include(
                "car_calibrate",
                "calibrate.launch.py",
                condition=IfCondition(start_calibrate),
            ),
            _include(
                "car_observation",
                "observation.launch.py",
